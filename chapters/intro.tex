...
(e.g. see \ref{drop_breakuo}) demonstrating that the drops do not undergo any significant deformation, 
...
where the rapid and uncontrolled growth of numerical errors of lead to severe deformations of the interface, 
