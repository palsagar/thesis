...
depending on whether the drop forms at the free ends (referred to as end-pinching \cite{end_pinch_1,end_pinch_2,end_pinch_3}) 
or via the disintegration of the main liquid column. 
The former mechanism is referred to as end pinching, the onset of which
is governed by several factors such as 
