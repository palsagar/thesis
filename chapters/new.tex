...
We assume a regular cubic (3D) or square grid (2D). 
We also use staggered velocity and pressure grids. 
This makes our method more complex than it would be on a
collocated grid.
...
This type of staggered representation
