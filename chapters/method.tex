...
where $\chi$ is the phase-characteristic function. 
...
the equations of fluid motion as described in \ref{nseqn} is provided by :  


\begin{equation}
\begin{aligned} 
	\rho(\boldsymbol x,t) &= \rho_{1}\chi(\boldsymbol x,t) + \left(1 - \chi(\boldsymbol x,t)\right)\rho_{2} \\ 
	\mu(\boldsymbol x,t) &= \mu_{1}\chi(\boldsymbol x,t) + \left(1 - \chi(\boldsymbol x,t)\right)\mu_{2}  
\end{aligned}
  \label{rho-mu}
\end{equation}
...
the function $\chi$ is modeled, either as a smooth differentiable function in
the case of level sets, or as a Heaviside function with its inherent discontinuity.  
...
For a more detailed and nuanced evaluation of the comparitive advantages of the different interfacial transport methods, we refer the reader to the recent review by Mirjalili et al. \cite{mirjalili2017interface} on the given subject.     
