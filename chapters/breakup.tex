...
The radial profile corresponding to an individual ligament simulation is 
uniquely determined by the value of the seed used as 
input for our random noise generator, therefore we are 
able to ensure that none of the ligaments in our 
ensembles are identical by simply using unique seeds for each realization. 
The amplitude of the surface corrugations are controlled by the 
dispersion of the initial white noise signal. 
The volume of the corrugated ligament per unit spatial period 
is controlled by our choice of ligament aspect-ratio.    
