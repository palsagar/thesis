...
\includegraphics{plots/ligament_breakup/3d_vs_2d_short.pdf}
	\caption{Temporal evolution of the ligament dynamics over \textit{short} time scales. 
	The physical parameters correspond to those defined in \eqref{base_params}.
	The top row (light blue shapes) represents the 2D axisymmetric simulations, 
	and the bottom row (deep blue shapes) represents full 3D simulations.
	The distances between the structures in the 3D case seem to be different from
	that of the 2D case, but in fact it is merely an effect of the 3D viewing angles
	used to represent the 3D case.}
\label{2d_3d_short}
\end{figure*}
...
\includegraphics{plots/ligament_breakup/3d_vs_2d_long.pdf}
	\caption{Temporal evolution of the ligament dynamics over \textit{long} time scales. 
	The physical parameters correspond to those defined in \eqref{base_params}.
	The top row (light blue shapes) represents the 2D axisymmetric simulations, 
	and the bottom row (deep blue shapes) represents full 3D simulations.
	The distances between the structures in the 3D case seem to be different from
...
% dynamics of millimeter scale water ligaments in air
% time-scales in milliseconds 
% slow time scales and fast time scales
